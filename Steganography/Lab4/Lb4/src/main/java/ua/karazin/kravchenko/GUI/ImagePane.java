...
public class ImagePane extends JComponent {
    ...
    public void readImage() {
        ...
        jFileChooser.addChoosableFileFilter(new FileNameExtensionFilter("Image file", ImageIO.getReaderFileSuffixes()));
    ...
    public void saveImage() {
        if (Objects.nonNull(bufferedImage)) {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                try {
                    System.out.println(ImageIO.write(bufferedImage, FilenameUtils.getExtension(jFileChooser.getSelectedFile().getName()), jFileChooser.getSelectedFile()));
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
